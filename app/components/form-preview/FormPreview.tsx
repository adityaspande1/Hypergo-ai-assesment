  ...
  return (
    <div className="h-full flex flex-col">
        ...
        <div className="bg-white dark:bg-gray-800 p-4 border-b dark:border-gray-700 flex justify-between items-center">
          ...
          <div className="flex space-x-2">
            <button
              ...
              className={`p-2 rounded-md ${device === 'desktop' ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300' : 'text-gray-500 dark:text-gray-400'}`}
              title="Desktop View"
            >
            ...
            <button
              ...
              className={`p-2 rounded-md ${device === 'tablet' ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300' : 'text-gray-500 dark:text-gray-400'}`}
              title="Tablet View"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
            ...
            <button
              ...
              className={`p-2 rounded-md ${device === 'mobile' ? 'bg-blue-100 dark:bg-blue-900 text-blue-700 dark:text-blue-300' : 'text-gray-500 dark:text-gray-400'}`}
              title="Mobile View"
            >
              <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
      ...
      <div className="flex-1 overflow-auto p-6 bg-gray-50 dark:bg-gray-900 flex justify-center">
        <div className={`bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md transition-all duration-300 ${getDeviceClass()} h-fit`}>
          {submitted ? (
            <div className="text-center py-8">
              ...
              <h3 className="mt-4 text-xl font-medium text-gray-900 dark:text-white">Form Submitted Successfully!</h3>
              <p className="mt-2 text-gray-500 dark:text-gray-400">Thank you for your submission.</p>
            </div>
          ) : (
